      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-12 mb-16">
          <div className="md:w-1/3">
            <img src={assetPath("/img/51eb80b4-8203-4dd3-8422-558925feec65.png")} alt="Christine Welden with harp" className="rounded-lg shadow-md w-full h-auto object-cover" />
          </div>
